...
#ifndef _DXGMX_COMPILER_ATTRS_H
#define _DXGMX_COMPILER_ATTRS_H
 ...
 * opt arg1: dealloc is a suitable deallocation function for ptrs obtained
 * through said malloc-like function
 */
#define _ATTR_MALLOC(...) __attribute__((malloc, __VA_ARGS__))
/* used on a malloc-like function
 ...
 */
#define _ATTR_ALWAYS_INLINE __attribute__((always_inline)) inline
/*
